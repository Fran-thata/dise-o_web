    ...
    <section id="servicios" className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Card 1: Web Corporativa (Standard) */}
          <Reveal delay={0} className="h-full">
            <div className="glass-card p-8 rounded-3xl hover:border-secondary-500/50 transition-colors duration-300 flex flex-col h-full">
              ...
              <ul className="space-y-3 mb-8 text-sm text-slate-300">
                 <li className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-secondary-400 mr-2"></span>Panel de control fácil</li>
          ...
          {/* Card 2: Landing Page (Highlighted - Middle) */}
          <Reveal delay={100} className="h-full">
            <div className="glass-card p-8 rounded-3xl border-primary-500/30 shadow-[0_0_30px_rgba(217,70,239,0.15)] relative flex flex-col scale-105 z-10 bg-[#0F131F] h-full">
              ...
              <ul className="space-y-3 mb-8 text-sm text-slate-300">
                 <li className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-primary-400 mr-2"></span>Copywriting persuasivo</li>
                 <li className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-primary-400 mr-2"></span>Carga ultrarrápida</li>
                 <li className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-primary-400 mr-2"></span>A/B Testing ready</li>
              </ul>
          ...
          <Reveal delay={200} className="h-full">
            <div className="glass-card p-8 rounded-3xl hover:border-primary-500/50 transition-colors duration-300 flex flex-col h-full">
              ...
              <p className="text-slate-400 mb-8 flex-grow">
                E-commerce a medida. Vende 24/7 con pasarelas de pago seguras y gestión de stock.
              </p>
              <ul className="space-y-3 mb-8 text-sm text-slate-300">
                 <li className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-secondary-400 mr-2"></span>Pagos (Stripe/Redsys)</li>
                 <li className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-secondary-400 mr-2"></span>Sin comisiones extra</li>
                 <li className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-secondary-400 mr-2"></span>Gestión avanzada</li>
              </ul>
              <button className="w-full py-3 rounded-xl border border-white/10 hover:bg-white/5 text-white font-medium transition-colors flex items-center justify-center">
                 Empezar tienda <ArrowRight size={16} className="ml-2" />
              </button>
            </div>
          </Reveal>
